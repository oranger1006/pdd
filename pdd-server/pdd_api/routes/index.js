 ...
 * 服饰导航
 */
router.get('/api/dressnav', (req, res) => {
    const data = require('../data/dressnav');
    res.json({success_code: 200, message: data});
});
 ...
 * 鞋包导航
 */
router.get('/api/boxnav', (req, res) => {
    const data = require('../data/boxnav');
    res.json({success_code: 200, message: data});
});
 ...
 * 母婴导航
 */
router.get('/api/babynav', (req, res) => {
    const data = require('../data/baby');
    res.json({success_code: 200, message: data});
});
 ...
 * 百货导航
 */
router.get('/api/generalnav', (req, res) => {
    const data = require('../data/general');
    res.json({success_code: 200, message: data});
});
 ...
 * 手机导航
 */
router.get('/api/phonenav', (req, res) => {
    const data = require('../data/phone');
    res.json({success_code: 200, message: data});
});
 ...
 * 运动导航
 */
router.get('/api/mannav', (req, res) => {
    const data = require('../data/man');
    res.json({success_code: 200, message: data});
});
 ...
 * 电器导航
 */
router.get('/api/elenav', (req, res) => {
    const data = require('../data/ele');
    res.json({success_code: 200, message: data});
});
